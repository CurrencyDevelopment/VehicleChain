...
const string strMessageMagic = "MVDSCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(unsigned int nBits, int64_t nFees, int nHeight)
{
    ...
    if (nHeight <= LAST_POW_BLOCK && nHeightCount > 1) {
        nSubsidy = 0.1 * COIN / nHeightCount;
    }
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("MVDSCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in MVDSCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // MVDSCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MVDSCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        unsigned int nTimeGenesis = fTestNet ? 1504484298 : 1504520298;

        unsigned int nNonceGenesis = fTestNet ? 6859225 : 6621147;

        const char* pszTimestamp = "MVDSC is data servie of vehicle Block Chain";
        CTransaction txNew;
        ...
        //// debug print
       if(fTestNet){
         assert(block.hashMerkleRoot == uint256("0xffdb529f2b5e6e80b578973642aa0272005c6485cabde2e3e7aee8c321446eda"));
       }
       else {
         assert(block.hashMerkleRoot == uint256("0x03140c91a51acab1422fbad3a776915f33512a53f8ece2a6579858678a22468a"));
       }
...
unsigned char pchMessageStart[4] = { 0xad, 0xab, 0x7c, 0xec };
